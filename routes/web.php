...
//pos controllers
Route::resource('pos_income_categories', PosIncomeCategoryController::class);
Route::resource('pos_incomes', PosIncomeController::class);
Route::get('sales_journal', [SalesJournalController::class, 'index'])->name('sales_journal.index');
...
// Add this to your routes file (web.php or a dedicated customer routes file)
Route::get('customer/data', 'CustomerController@customerData')->name('customer.data');
