...
// Fetch the records for employees filtered by pos_accnt_id (based on logged-in admin's pos_accnt_id)
        $lims_employee_all = Employee::where('is_active', true)
            ->where('pos_accnt_id', $admin_pos_accnt_id)  // Filtering by pos_accnt_id
            ->get();
   ...
   public function store(Request $request)
{
    ...
    // Add pos_accnt_id to employee data
    ...
    if(isset($data['user'])){
        ...
        // Also add pos_accnt_id to the user data if needed
        $userData = $data;
        $userData['pos_accnt_id'] = $admin_pos_accnt_id;
    ...
    // Create employee with pos_accnt_id included
