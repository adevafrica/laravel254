                ...
                <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                    ...
                    <li class="nav-item">
                        <a rel="nofollow" id="notify-btn"  href="#" class="nav-link dropdown-item" data-toggle="tooltip" title="{{__('Notifications')}}">
                            ...
                            @if(auth()->user()->unreadNotifications->where('pos_accnt_id', auth()->user()->pos_accnt_id)->count())
    <span class="badge badge-danger">
        {{ auth()->user()->unreadNotifications->where('pos_accnt_id', auth()->user()->pos_accnt_id)->count() }}
    </span>
@endif
                        ...
                        <ul class="right-sidebar">
                            ...
                            @foreach(auth()->user()->notifications->where('data.pos_accnt_id', auth()->user()->pos_accnt_id) as $notification)
    <li>
        <a class="unread-notification" href="{{ $notification->data['link'] }}">
