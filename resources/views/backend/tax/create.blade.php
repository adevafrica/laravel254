...
<div id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    ...
    {{Form::text('TAX_SHORT_DESC', null, ['class' => 'form-control'])}}
</div>


                    <div class="form-group">
                        <label>{{trans('file.Rate')}}(%) *</label>
                        {{Form::number('rate', null, ['required' => 'required', 'class' => 'form-control', 'step' => 'any'])}}
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <a href="sample_file/sample_tax.csv" class="btn btn-info btn-block btn-md"><i class="dripicons-download"></i>  {{trans('file.Download')}}</a>
                    </div>
                </div>
            </div>
            <input type="submit" value="{{trans('file.submit')}}" class="btn btn-primary">
