    ...
    <div class="input-group">
        ...
        <div class="input-group-append">
            <button id="togglePassword" type="button" class="btn btn-default">
                <i class="fa fa-eye"></i> <!-- Eye icon for visibility -->
            </button>
    ...
    @endif
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" id="biller-id">
                                        ...
                                        <select name="biller_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Cashier...">
