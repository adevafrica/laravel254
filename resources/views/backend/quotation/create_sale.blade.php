    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <div class="input-group-append">
                <button type="button" class="btn btn-primary" onclick="generateReference()">
                    <i class="fa fa-plus"></i>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="biller_id" id="biller_id" class="selectpicker form-control" data-live-search="true" title="Select Cashier...">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="tax">{{ number_format((float)$product_quotation->tax, $general_setting->decimal, '.', '')}}</td>
                                                        <td class="sub-total">{{ number_format((float)$product_quotation->total, $general_setting->decimal, '.', '')}}</td>
...
$('select[name="payment_status"]').on("change", function() {
    ...
    if (payment_status == 4) { // If Payment Status is "Paid"
        $("#paid-amount").val(subtotal.toFixed(2)); // Set Paid Amount to Subtotal
        $("#paid-amount").prop('disabled', true);  // Disable editing
    } else {
        $("#paid-amount").val(''); // Reset if status changes
        $("#paid-amount").prop('disabled', false); // Enable editing
    }
    ...
    function generateReference() {
        // Generate a unique reference number (e.g., REF-12345)
        var randomNum = Math.floor(10000 + Math.random() * 90000);
        var referenceNo = "REF-" + randomNum;
        
        // Set the generated value into the input field
        document.getElementById("reference_no").value = referenceNo;
    }
