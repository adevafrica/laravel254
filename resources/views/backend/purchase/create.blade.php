    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <div class="input-group-append">
                <button type="button" class="btn btn-primary" id="generate_ref">
...
<script type="text/javascript">
   ...
   document.getElementById("generate_ref").addEventListener("click", function() {
        function generateReferenceNo() {
            let timestamp = Date.now(); // Current timestamp
            let randomNum = Math.floor(Math.random() * 1000); // Random number (0-999)
            return "REF" + timestamp + randomNum; // Example format: REF1679268123456789
        }

        document.getElementById("reference_no").value = generateReferenceNo();
    });
</script>
