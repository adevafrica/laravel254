...
<body>
    ...
    <div id="documenter_content">
        <section id="documenter_cover">
            ...
            <hr>
            <ul>
                <li>By: {{$general_setting->developed_by}}</li>
            </ul>
            <p>{{$general_setting->site_title}} is a software that will help you to manage your inventory, accounting and hrm. We believe that this software is suitable for both wholesale and retail buisness model and an ideal product for any Super Shop. This user friendly software is fully responsive and has many features. Hope that this software will be helpful to manage your buisness inventory.</p>
        </section>
        ...
        <section id="update">
            ...
            <ul>
                <li>Rename your previous database like {{$general_setting->site_title}}-backup.sql.</li>
                ...
                <li>After that delete the new database and rename the previous one with present database name like {{$general_setting->site_title}}-backup.sql to {{$general_setting->site_title}}.sql.</li>
            </ul>
        ...
        <section id="print-barcode">
            ...
            <P>You can print barcode with {{$general_setting->site_title}}. The available paper sizes are 36mm, 24mm and 18mm. Anything other than that might not work correctly. To print barcodes we highly recommend using <strong>Brother Label Printer.</strong></P>
        </section>
        ...
        <section id="reports">
            ...
            <p>You can create generate various reports automatically by using {{$general_setting->site_title}}.</p>
            <ul>
