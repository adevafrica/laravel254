...
<!-- Hidden input to store user's pos_accnt_id -->
<input type="hidden" id="pos_accnt_id" value="{{ Auth::user()->pos_accnt_id }}">
...
<script type="text/javascript">
    ...
    var pos_accnt_id = $('#pos_accnt_id').val(); // Get the logged-in admin's pos_accnt_id
    ...
    $('#purchase-table').DataTable({
        ...
        "ajax":{
            ...
            data:{
                ...
                pos_accnt_id: pos_accnt_id // Add pos_accnt_id parameter
            },
            dataType: "json",
            type:"post"
        },
