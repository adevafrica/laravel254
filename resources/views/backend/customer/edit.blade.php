...
<section class="forms">
    ...
    <div class="form-group">
        ...
        <input type="text" name="MemberNo" value="{{$lims_customer_data->MemberNo}}" class="form-control">
    </div>
</div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Campus</label>
                                    <input type="text" name="address" value="{{$lims_customer_data->company_name}}" class="form-control">
                                </div>
                            </div>
