                ...
                <div class="card">
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5">
                         ...
                         <div class="column-5">
<button style="background-color: #16dbde;" type="button" class="btn btn-sm btn-custom" id="cancel-btn" onclick="window.location.href='https://uhai.africa/pos'">
    <i class="fa fa-store"></i> POS
</button>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <!-- @php
                                                $options = explode(',', $lims_pos_setting_data->payment_options);
                                            @endphp -->
<select class="form-control selectpicker payment-option" disabled>
    @if(in_array("cash", $options))
        <option value="1" disabled>Cash</option>
    @endif

    @if(in_array("deposit", $options))
        <option value="6" disabled>MPESA (Other)</option>
    @endif
</select>
                    ...
                    <div class="col-md-12 mt-1 table-container">
                        <table id="product-table" class="table product-list">
                            ...
                            @for ($i=0; $i < ceil($product_number/5); $i++)
                                <tr>
                                    <td class="product-img sound-btn" title="{{$lims_product_list[0+$i*5]->name}}" data-product ="{{$lims_product_list[0+$i*5]->code.'|'.$lims_product_list[0+$i*5]->name.'|null|0'}}"><img  src="{{url('images/product',$lims_product_list[0+$i*5]->base_image)}}" width="100%" />
                                        <p>{{$lims_product_list[0+$i*5]->name}}</p>
                                        <span>{{$lims_product_list[0+$i*5]->code}}</span>
                                    </td>
                                    @if(!empty($lims_product_list[1+$i*5]))
                                    <td class="product-img sound-btn" title="{{$lims_product_list[1+$i*5]->name}}" data-product ="{{$lims_product_list[1+$i*5]->code . '|' . $lims_product_list[1+$i*5]->name . '|null|0'}}"><img  src="{{url('images/product',$lims_product_list[1+$i*5]->base_image)}}" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[2+$i*5]->name}}" data-product ="{{$lims_product_list[2+$i*5]->code . '|' . $lims_product_list[2+$i*5]->name . '|null|0'}}"><img  src="{{url('images/product',$lims_product_list[2+$i*5]->base_image)}}" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[3+$i*5]->name}}" data-product ="{{$lims_product_list[3+$i*5]->code . '|' . $lims_product_list[3+$i*5]->name . '|null|0'}}"><img  src="{{url('images/product',$lims_product_list[3+$i*5]->base_image)}}" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[4+$i*5]->name}}" data-product ="{{$lims_product_list[4+$i*5]->code . '|' . $lims_product_list[4+$i*5]->name . '|null|0'}}"><img  src="{{url('images/product',$lims_product_list[4+$i*5]->base_image)}}" width="100%" />
