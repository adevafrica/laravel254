      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            ...
            <br><br>
            @endif
            <a href="{{ route('password.request') }}" class="forgot-pass" style="font-size:20px;">
    {{trans('file.Forgot Password?')}}
</a>
<p class="register-section" style="font-size: 18px; color:black;">
    {{trans('file.Do not have an account?')}}
</p>
<a href="{{url('register')}}" class="signup register-section" style="font-size: 18px;">
    {{trans('file.Register')}}
</a>
