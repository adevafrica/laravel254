...
@if($index_permission_active)
<li>
    <a href="#pos_income" aria-expanded="false" data-toggle="collapse">
        <i class="dripicons-wallet"></i>
        <span>{{ trans('POS Income') }}</span>
    </a>
    <ul id="pos_income" class="collapse list-unstyled">
        <li id="pos-inc-cat-menu">
            <a href="{{ route('pos_income_categories.index') }}">
                {{ trans('POS Income Category') }}
            </a>
        </li>
        <li id="pos-inc-list-menu">
            <a href="{{ route('pos_incomes.index') }}">
                {{ trans('POS Income List') }}
            </a>
        </li>

        @php
            $add_pos_income_permission = $role_has_permissions_list->where('name', 'pos-incomes-add')->first();
        @endphp
        @if($add_pos_income_permission)
        <li>
            <a id="add-pos-income" href="{{ route('pos_incomes.create') }}">
                {{ trans('Add POS Income') }}
            </a>
        </li>
        @endif

        {{-- Sales Journal link - No permission required --}}
        <li id="sales-journal-menu">
            <a href="{{ route('sales_journal.index') }}">
                {{ trans('Sales Journal') }}
            </a>
        </li>
<li id="income-statement-menu">
...
@endif
            ...
            <ul id="report" class="collapse list-unstyled ">
                ...
                <a href="{{url('report/daily_sale/'.date('Y').'/'.date('m'))}}">Sales Per Product</a>
                </li>
                @endif
                ...
                <a href="{{route('report.warehouseStock')}}">Loyalty Point Slips</a>
                </li>
                @endif
 ...
 @if($product_expiry_report_active)
                ...
                <a href="{{route('report.productExpiry')}}">Loyalty Points Sales</a>
                </li>
                @endif
