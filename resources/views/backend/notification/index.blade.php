        ...
        <table id="notification-table" class="table">
            ...
            <tbody>
                ...
                <?php 
                    ...
                    $from_user = \DB::table('users')->select('name')->where('id', $data->sender_id)->where('pos_accnt_id', auth()->user()->pos_accnt_id)->first();
                    $to_user = \DB::table('users')->select('name')->where('id', $data->receiver_id)->where('pos_accnt_id', auth()->user()->pos_accnt_id)->first();
                    
                    // If either user is not in the same account, skip rendering this notification
